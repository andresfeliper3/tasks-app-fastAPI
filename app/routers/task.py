...
@task_router.get('/tasks', response_model=List[Task], status_code=200)  # , dependencies=[Depends(JWTBearer())])
...
@task_router.post('/tasks', response_model=dict)
...
@task_router.put('/tasks/{id}', response_model=dict)
...
@task_router.delete('/tasks/{id}', response_model=dict)
...
@task_router.delete('/tasks-all', response_model=dict)
